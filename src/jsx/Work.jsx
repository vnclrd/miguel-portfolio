...
function Work() {
  ...
  return (
    <div 
      id='work' 
      className='flex flex-col items-center justify-center bg-[#0d1b2a] min-h-screen w-full px-4 py-12 lg:py-26'
    >
      {/* Section Title */}
      ...
      <div className='flex flex-col lg:flex-row lg:flex-wrap justify-center items-center lg:items-start w-full max-w-[1400px] gap-16 lg:gap-12 xl:gap-20'>
        ...
        <div className='flex flex-col items-center w-full max-w-sm lg:w-[300px] xl:w-[450px] relative'>
          ...
          <div className='bg-[#000e1e] p-2 lg:w-[300px] mt-2 lg:mt-2'>
            <p className='text-[#e0e0e0] text-[0.6rem] text-center lg:text-justify'>
              Ala is a web app that lets event organizers and guests capture and share photos in one place, creating a <span className='text-[#00b4d8] font-semibold'>collective memory wall</span> that everyone can relive together.
            </p>
          </div>
        </div>
        ...
        <div className='flex flex-col items-center w-full max-w-sm lg:w-[300px] xl:w-[450px] relative'>
          ...
          <div className='bg-[#000e1e] p-2 lg:w-[300px] mt-2 lg:mt-2'>
            <p className='text-[#e0e0e0] text-[0.6rem] text-center lg:text-justify'>
              Developed a <span className='text-[#00b4d8] font-semibold'>full-stack printing kiosk</span> utilizing Python + Flask and WebSocket-based payment tracking with PayMongo integration.
            </p>
          </div>
        </div>
      </div>
