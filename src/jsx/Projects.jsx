    ...
    <div id='projects' className='projects-container'>
      ...
      <div className='projects-projects'>
        <div className='project-1'>
          ...
          <h1 className='project-h1'>TrainIn</h1>
          <p className='project-subtitle'>Automated Attendance System App</p>
        ...
        <div className='project-2'>
          ...
          <h1 className='project-h1'>InstaPrint</h1>
          <p className='project-subtitle'>Self-Service Printing Kiosk</p>
        ...
        <div className='project-3'>
          ...
          <h1 className='project-h1'>ShouldU</h1>
          <p className='project-subtitle'>Summarization App</p>
